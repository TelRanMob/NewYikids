...
public class TaniaDataProviders {
    @DataProvider
    public static Iterator<Object[]> loadInvalidSingUpFromFile() throws IOException {
        BufferedReader in = new BufferedReader(new InputStreamReader(
                TaniaDataProviders.class.getResourceAsStream("/TaniaNegSingUp.data")));
    ...
    public static Iterator<Object[]> loadLogins() throws IOException {
        BufferedReader in = new BufferedReader(new InputStreamReader(
                TaniaDataProviders.class.getResourceAsStream("/registeredLogins.data")));
    ...
    public static Iterator<Object[]> loadInvalidLoginFromFile() throws IOException {
        BufferedReader in = new BufferedReader(new InputStreamReader(
                TaniaDataProviders.class.getResourceAsStream("/invalidLogin.data")));
    ...
    @DataProvider
    public static Iterator<Object[]> aliasNegativeTests() throws IOException {
        BufferedReader in = new BufferedReader(new InputStreamReader(
                TaniaDataProviders.class.getResourceAsStream("/aliasNegative.data")));
    ...
    public static Iterator<Object[]> SignUpAddress() throws IOException {
        BufferedReader in = new BufferedReader(new InputStreamReader(
                TaniaDataProviders.class.getResourceAsStream("/webinar.data")));
    ...
    public static Iterator<Object[]> loadGrafFromFile() throws IOException {
        BufferedReader in = new BufferedReader(new InputStreamReader(
                TaniaDataProviders.class.getResourceAsStream("/graphs.data")));
    ...
    public static Iterator<Object[]> loadProfileDataFromFile() throws IOException {
        BufferedReader in = new BufferedReader(new InputStreamReader(
                TaniaDataProviders.class.getResourceAsStream("/profile2.data")));
    ...
    public static Iterator<Object[]> loadTypesFromFile() throws IOException {
        BufferedReader in = new BufferedReader(new InputStreamReader(
                TaniaDataProviders.class.getResourceAsStream("/progress.data")));
    ...
    public static Iterator<Object[]> loadMedicineTypesFromFile() throws IOException {
        BufferedReader in = new BufferedReader(new InputStreamReader(
                TaniaDataProviders.class.getResourceAsStream("/medicine.data")));
    ...
    public static Iterator<Object[]> optionsFromFile() throws IOException {
        BufferedReader in = new BufferedReader(new InputStreamReader(
                TaniaDataProviders.class.getResourceAsStream("/options.data")));
    ...
    public static Iterator<Object[]> loadEmpDataFromFile() throws IOException {
        BufferedReader in = new BufferedReader(new InputStreamReader(
                TaniaDataProviders.class.getResourceAsStream("/addEmp.data")));
    ...
    public static Iterator<Object[]> loadDataForProfile() throws IOException {
        BufferedReader in = new BufferedReader(new InputStreamReader(
                TaniaDataProviders.class.getResourceAsStream("/profiles.data")));
    ...
    public static Iterator<Object[]> loadNegativeDataForProfile() throws IOException {
        BufferedReader in = new BufferedReader(new InputStreamReader(
                TaniaDataProviders.class.getResourceAsStream("/profilesNegative.data")));
    ...
    public static Iterator<Object[]> loadDataForMDRating() throws IOException {
        BufferedReader in = new BufferedReader(new InputStreamReader(
                TaniaDataProviders.class.getResourceAsStream("/mdrating.data")));
